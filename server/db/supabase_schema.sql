...
CREATE TABLE IF NOT EXISTS public.empresas (
    ...
    bloquear_credito_combustiveis INTEGER NOT NULL DEFAULT 1,
    ncm_vedados_credito TEXT DEFAULT '2710,2711',
    cnae_principal VARCHAR(10) DEFAULT NULL,
    inscricao_suframa VARCHAR(20) DEFAULT NULL,
    grupo_contabil VARCHAR(100) DEFAULT 'Carteira Geral',
...
-- ============================================================
-- 14. APURAÇÃO ASSISTIDA & CONTA CORRENTE FISCAL (CGIBS / RTC)
-- ============================================================
