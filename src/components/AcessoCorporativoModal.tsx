...
export const AcessoCorporativoModal: React.FC<AcessoCorporativoModalProps> = ({
  ...
  return (
    <div className="space-y-6">
      {/* Header Banner */}
      <div className="p-6 rounded-2xl bg-gradient-to-r from-slate-900 via-indigo-950 to-blue-950 border border-slate-800 shadow-xl flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        <div>
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-indigo-900/60 border border-indigo-700/60 text-indigo-300 text-xs font-bold mb-2">
            ...
            Segurança Corporativa & Autenticação Forte (MFA)
          </div>
          <h2 className="text-2xl font-extrabold text-white tracking-tight">
            Acesso Único Corporativo, 2FA & Perfis Admin
          </h2>
          <p className="text-xs text-slate-300 max-w-2xl mt-1">
            Controle centralizado de acessos com verificação em duas etapas, restrição de permissões por perfil (Contador, Analista, Auditor) e liberação de CNPJs por usuário.
          </p>
        </div>

        <div className="px-4 py-2.5 rounded-xl bg-slate-950 border border-slate-800 text-xs text-right">
          <div className="text-slate-400">Usuário Logado:</div>
          <div className="font-extrabold text-white">{currentUser.nome}</div>
          <div className="text-[10px] text-cyan-400 font-mono uppercase">{currentUser.perfil.replace('_', ' ')}</div>
        </div>
      </div>
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-slate-800 pb-4">
              <div>
                <h3 className="text-base font-bold text-white flex items-center gap-2">
                  ...
                  Gestão de Usuários Corporativos e CNPJs Liberados
                </h3>
                <p className="text-xs text-slate-400 mt-0.5">
                  Liberador de acessos central. O Admin Master define quais CNPJs e módulos cada usuário pode manipular.
                </p>
              </div>
              ...
              >
                ...
                <span>Convidar / Liberar Novo Usuário</span>
              </button>
            </div>
